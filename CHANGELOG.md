...
### Updated
- **Updated**: Disable showing empty placeholder elements in the head section when no head elements are added

## [2.3.1] - 2025-10-06

### Added
- **Added**: Rendering html attributes like defer, async without value for script tags (e.g. `<script src="..." defer></script>`) instead of `<script src="..." defer="defer"></script>`

## [2.3.1] - 2025-10-02

### Fixed
- **Fixed**: Possible cache type (added \Magento\Framework\App\CacheInterface type)
